...
class resumeExtraction:
    def __init__(self):
        ...
        # Education Degrees
        self.EDUCATION = [
                    'BE', 'BSC', 'BS','BCS','BSCS','BS (Computer Science)','D.A.E (Mechanical)','B.E (Telecommunication  Engineering)',
                    'CCNA','CCNP','MPLS','VoIP','ME','MS','BCOM','BCS','BCA','MCA',
                    'BTECH', 'MTECH','DIPLOMA','12TH','10TH',
                    'SSC', 'HSC', 'CBSE', 'ICSE', 'X', 'XII', 'XTH','XIITH','FE','SE','TE'
                ]
        #AI-IR\WebApp\static\data\newskill2.csv
        self.data= pd.read_csv("WebApp/static/data/newskill2.csv") 
    ...
    def extractorData(self,file,ext): #
        ...
        # print(education1)
        return (name,mobile_no,email,skills,text1)

resumeExtractor = resumeExtraction()
#AI-IR\WebApp\static\resume\Ali_Rehmans_Resume_.pdf
#AI-IR\WebApp\static\resume\ADNAN_AHMED_-_CV_for_Research_Assistants_-_Lab_Instructors.txt
#print(resumeExtractor.extractorData('AI-IR/WebApp/static/resume/Ali_Rehmans_Resume_.pdf',"pdf"))
